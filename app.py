...
#1: końcówka  - funkcja do pobierania  danych
@app.route("/api/v1/homelib/", methods=["GET"]) 
def homelib_list_api_v1(): 
    return jsonify(homelib.all())

#2: końcówka  - funkcja do pobierania  danych wg ID - GET
...
#3: końcówka  - funkcja do  dodawania nowego elementu homelibrary  - POST
...
#4: końcówka  - funkcja do usuwania tasków  - DELETE
...
#5: końcówka  - funkcja do nadpisywania  tasków - PUT
